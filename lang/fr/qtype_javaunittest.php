<?php
/**
 * Strings for component 'qtype_javaunittest', language 'fr'
 *
 * @package    qtype
...
$string['pluginname_help'] = 'Type de question JUnit';
$string['pluginname_link'] = 'question/type/javaunittest';
$string['pluginnameadding'] = 'Ajouter une question javaunittest';
$string['pluginnameediting'] = 'Modifier une question javaunittest';
...
// feedback
$string['auditlevel'] = 'Pondération';
$string['AUDIT_VALUE_10'] = '10%';
$string['AUDIT_VALUE_20'] = '20%';
$string['AUDIT_VALUE_30'] = '30%';
$string['AUDIT_VALUE_40'] = '40%';
$string['AUDIT_VALUE_50'] = '50%';
$string['AUDIT_VALUE_60'] = '60%';
$string['AUDIT_VALUE_70'] = '70%';
$string['AUDIT_VALUE_80'] = '80%';
$string['AUDIT_VALUE_90'] = '90%';

$string['feedbacklevel'] = 'Feedback';
$string['feedback_nothing'] = 'Rien';
$string['feedback_only_times'] = 'Temps';
$string['feedback_times_count_of_tests'] = 'Temps et compteur de tests/erreurs';
$string['feedback_all_except_stacktrace'] = 'Tout sauf la stacktraces';
$string['feedback_all'] = 'Tout';
$string['CA'] = 'BONNE REPONSE: Tout est bon.';
$string['PCA'] = 'PARTIELLEMENT CORRECT: Certaines réponses sont correctes, d\'autres non.';
$string['WA'] = 'FAUSSE REPONSE: Tout est faux.';
$string['CE'] = 'ERREUR DE COMPILATION: Votre code source ne compile pas. Vérifiez et corrigez les erreurs.';
...
$string['TO'] = 'TIMEOUT: Le temps d\'execution limite imparti est atteint.';
...
$string['debug_heading'] = 'Information de debug local';
$string['debug_heading_desc'] = 'Activer uniquement pour les tests ! (juste pour l\'execution local de java)';
$string['debug_logfile'] = 'Sauvegarder les fichiers de log dans le dossier temporaire';
$string['debug_nocleanup'] = 'Ne pas effacer les fichiers et dossiers temporaires';
