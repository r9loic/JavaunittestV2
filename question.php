...
class qtype_javaunittest_question extends question_graded_automatically {
	...
	else if($this->auditlevel == AUDIT_VALUE_20) {
	$weight_style = 0.2;
	}
	else if($this->auditlevel == AUDIT_VALUE_30) {
	$weight_style = 0.3;
	}
	else if($this->auditlevel == AUDIT_VALUE_40) {
	$weight_style = 0.4;
	}
	else if($this->auditlevel == AUDIT_VALUE_50) {
	$weight_style = 0.5;
	}
	else if($this->auditlevel == AUDIT_VALUE_60) {
	$weight_style = 0.6;
	}
	else if($this->auditlevel == AUDIT_VALUE_70) {
	$weight_style = 0.7;
	}
	else if($this->auditlevel == AUDIT_VALUE_80) {
	$weight_style = 0.8;
	}
	else if($this->auditlevel == AUDIT_VALUE_90) {
	$weight_style = 0.9;
	}
